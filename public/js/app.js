...
$('#submit-image-field').click(function (e) {
    ...
    var status = $("input[name*='success_action_status']").val();
    var policy = $("input[name*='policy']").val();
    var XamzCredential = $("input[name*='X-amz-credential']").val();
    var XamzAlgorithm = $("input[name*='X-amz-algorithm']").val();
    var XamzDate = $("input[name*='X-amz-date']").val();
    var XamzSignature = $("input[name*='X-amz-signature']").val();
